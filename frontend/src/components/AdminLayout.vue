...
import { DataLine, Location, Tickets, SuitcaseLine, SwitchButton, Van, User } from "@element-plus/icons-vue";

const route = useRoute();
const router = useRouter();
const auth = useAuthStore();

const navItems = computed(() => auth.isTraveler ? [
  { path: "/travel", label: "游客门户", icon: Van }
] : [
...
const roleDescription = computed(() => auth.isAdmin ? "可维护业务数据" : "可浏览与预订路线");
